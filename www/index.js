...
Module['FS_createPath']("/data/fonts", "Mangaka", true, true);
Module['FS_createPath']("/data", "meshes", true, true);
Module['FS_createPath']("/data/meshes", "controllers", true, true);
Module['FS_createPath']("/data/meshes", "cube", true, true);
Module['FS_createPath']("/data/meshes", "torus", true, true);
Module['FS_createPath']("/data", "textures", true, true);
Module['FS_createPath']("/data/textures", "buttons", true, true);
Module['FS_createPath']("/data/textures", "environments", true, true);
    ...
    loadPackage({"files": [{"filename": "/data/fonts/Mangaka/Mangaka.json", "start": 0, "end": 402413}, {"filename": "/data/fonts/Mangaka/Mangaka.png", "start": 402413, "end": 688164}, {"filename": "/data/meshes/arrow.mtl", "start": 688164, "end": 688217}, {"filename": "/data/meshes/arrow.obj", "start": 688217, "end": 693432}, {"filename": "/data/meshes/controllers/left_controller.glb", "start": 693432, "end": 911416}, {"filename": "/data/meshes/controllers/right_controller.glb", "start": 911416, "end": 1125284}, {"filename": "/data/meshes/cube.mtl", "start": 1125284, "end": 1125537}, {"filename": "/data/meshes/cube.obj", "start": 1125537, "end": 1126291}, {"filename": "/data/meshes/cube/cube.mtl", "start": 1126291, "end": 1126539}, {"filename": "/data/meshes/cube/cube.obj", "start": 1126539, "end": 1127526}, {"filename": "/data/meshes/cube/cube_checkerboard.png", "start": 1127526, "end": 1143661}, {"filename": "/data/meshes/raycast.mtl", "start": 1143661, "end": 1144106}, {"filename": "/data/meshes/raycast.obj", "start": 1144106, "end": 1185953}, {"filename": "/data/meshes/sphere.mtl", "start": 1185953, "end": 1186202}, {"filename": "/data/meshes/sphere.obj", "start": 1186202, "end": 1263472}, {"filename": "/data/meshes/torus/torus.mtl", "start": 1263472, "end": 1263721}, {"filename": "/data/meshes/torus/torus.obj", "start": 1263721, "end": 1345929}, {"filename": "/data/textures/buttons/a.png", "start": 1345929, "end": 1366694}, {"filename": "/data/textures/buttons/b.png", "start": 1366694, "end": 1387638}, {"filename": "/data/textures/buttons/y.png", "start": 1387638, "end": 1407576}, {"filename": "/data/textures/circle_white.png", "start": 1407576, "end": 1412211}, {"filename": "/data/textures/cube_checkerboard.png", "start": 1412211, "end": 1428346}, {"filename": "/data/textures/environments/sky.hdr", "start": 1428346, "end": 6461594}, {"filename": "/data/textures/slider.png", "start": 6461594, "end": 6466663}, {"filename": "/data/textures/submenu_mark.png", "start": 6466663, "end": 6473774}], "remote_package_size": 6473774});
...
// Begin JS library code
  ...
  var _emwgpuDeviceCreateComputePipelineAsync = function(devicePtr, futureId, descriptor, pipelinePtr) {
    futureId = bigintToI53Checked(futureId);
      ...
      WebGPU.Internals.futureInsert(futureId, device.createComputePipelineAsync(desc).then((pipeline) => {
        ...
        _emwgpuOnCreateComputePipelineCompleted(futureId, 1,
          pipelinePtr, 0);
      }, (pipelineError) => {
        ...
        var status =
          pipelineError.reason === 'validation' ? 3 :
          pipelineError.reason === 'internal' ? 4 :
          0;
        
        _emwgpuOnCreateComputePipelineCompleted(futureId, status,
          pipelinePtr, messagePtr);
        stackRestore(sp);
      }));
    ;
  };
  ...
  var _emwgpuDeviceCreateRenderPipelineAsync = function(devicePtr, futureId, descriptor, pipelinePtr) {
    futureId = bigintToI53Checked(futureId);
      ...
      WebGPU.Internals.futureInsert(futureId, device.createRenderPipelineAsync(desc).then((pipeline) => {
        ...
        WebGPU.Internals.jsObjectInsert(pipelinePtr, pipeline);
        _emwgpuOnCreateRenderPipelineCompleted(futureId, 1,
          pipelinePtr, 0);
      }, (pipelineError) => {
  ...
  function _webxr_get_input_axes(source, outAxesPtr) {
  ...
  function _webxr_get_input_button(source, buttonId, outButtonPtr) {
      let f = Module['webxr_frame'];
      if(!f) {
  ...
  async function _webxr_init(frameCallback, initWebXRCallback, startSessionCallback, endSessionCallback, errorCallback, userData) {
  ...
  _webxr_init.isAsync = true;

  
  async function _webxr_is_session_supported(mode, callback, userData) {
      if (!navigator.xr || !navigator.gpu || !('XRGPUBinding' in window) ) {
          dynCall('viii', callback, [userData, mode, 0]);
          return;
      }
      await navigator.xr.isSessionSupported('immersive-vr').then(function(supported) {
          dynCall('viii', callback, [userData, mode, supported]);
      }, function() {
          dynCall('viii', callback, [userData, mode, false]);
      });
  }
  _webxr_is_session_supported.isAsync = true;

  async function _webxr_set_device(gpuDevice) {
      WebXR.gpuDevice = WebGPU.getJsObject(gpuDevice);
  }
  _webxr_set_device.isAsync = true;
  ...
  var _wgpuSurfaceConfigure = (surfacePtr, config) => {
      ...
      var viewFormatCount = HEAPU32[(((config)+(24))>>2)];
      if (viewFormatCount) {
        var viewFormatsPtr = HEAPU32[(((config)+(28))>>2)];
        // viewFormatsPtr pointer to an array of TextureFormat which is an enum of size uint32_t
...
function on_render() { if (Module.Engine.onRender) { Module.Engine.onRender(); } }
function on_update(delta_time) { if (Module.Engine.onUpdate) { Module.Engine.onUpdate(delta_time); } }
function canvas_get_width() { return canvas.clientWidth; }
function canvas_get_height() { return canvas.clientHeight; }
function get_html5_resize_target() { var str = "html5ResizeTarget" in Module ? Module.html5ResizeTarget : ""; var lengthBytes = lengthBytesUTF8(str) + 1; var ptr = _malloc(lengthBytes); stringToUTF8(str, ptr, lengthBytes); return ptr; }
...
var wasmImports = {
  ...
  /** @export */
  emwgpuDeviceCreateComputePipelineAsync: _emwgpuDeviceCreateComputePipelineAsync,
  /** @export */
  emwgpuDeviceCreateRenderPipelineAsync: _emwgpuDeviceCreateRenderPipelineAsync,
  /** @export */
  ...
  /** @export */
  webxr_get_input_axes: _webxr_get_input_axes,
  /** @export */
  webxr_get_input_button: _webxr_get_input_button,
  /** @export */
  ...
  /** @export */
  webxr_set_device: _webxr_set_device,
  /** @export */
...
var dynCall_iiiiifii = Module['dynCall_iiiiifii'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_iiiiifii = Module['dynCall_iiiiifii'] = wasmExports['dynCall_iiiiifii'])(a0, a1, a2, a3, a4, a5, a6, a7);
var dynCall_iiiifii = Module['dynCall_iiiifii'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiifii = Module['dynCall_iiiifii'] = wasmExports['dynCall_iiiifii'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_iiiiifi = Module['dynCall_iiiiifi'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiifi = Module['dynCall_iiiiifi'] = wasmExports['dynCall_iiiiifi'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_iiiifi = Module['dynCall_iiiifi'] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiifi = Module['dynCall_iiiifi'] = wasmExports['dynCall_iiiifi'])(a0, a1, a2, a3, a4, a5);
...
var dynCall_iiiiiif = Module['dynCall_iiiiiif'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiiif = Module['dynCall_iiiiiif'] = wasmExports['dynCall_iiiiiif'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_iiiiif = Module['dynCall_iiiiif'] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiiif = Module['dynCall_iiiiif'] = wasmExports['dynCall_iiiiif'])(a0, a1, a2, a3, a4, a5);
...
var dynCall_iiiiiff = Module['dynCall_iiiiiff'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiiff = Module['dynCall_iiiiiff'] = wasmExports['dynCall_iiiiiff'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_iiiiff = Module['dynCall_iiiiff'] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiiff = Module['dynCall_iiiiff'] = wasmExports['dynCall_iiiiff'])(a0, a1, a2, a3, a4, a5);
...
var dynCall_fifffff = Module['dynCall_fifffff'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_fifffff = Module['dynCall_fifffff'] = wasmExports['dynCall_fifffff'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_ffffff = Module['dynCall_ffffff'] = (a0, a1, a2, a3, a4, a5) => (dynCall_ffffff = Module['dynCall_ffffff'] = wasmExports['dynCall_ffffff'])(a0, a1, a2, a3, a4, a5);
var dynCall_viff = Module['dynCall_viff'] = (a0, a1, a2, a3) => (dynCall_viff = Module['dynCall_viff'] = wasmExports['dynCall_viff'])(a0, a1, a2, a3);
var dynCall_fiffifff = Module['dynCall_fiffifff'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_fiffifff = Module['dynCall_fiffifff'] = wasmExports['dynCall_fiffifff'])(a0, a1, a2, a3, a4, a5, a6, a7);
var dynCall_fffifff = Module['dynCall_fffifff'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_fffifff = Module['dynCall_fffifff'] = wasmExports['dynCall_fffifff'])(a0, a1, a2, a3, a4, a5, a6);
...
var dynCall_viffiii = Module['dynCall_viffiii'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viffiii = Module['dynCall_viffiii'] = wasmExports['dynCall_viffiii'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_viiffiii = Module['dynCall_viiffiii'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_viiffiii = Module['dynCall_viiffiii'] = wasmExports['dynCall_viiffiii'])(a0, a1, a2, a3, a4, a5, a6, a7);
var dynCall_viffiiii = Module['dynCall_viffiiii'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_viffiiii = Module['dynCall_viffiiii'] = wasmExports['dynCall_viffiiii'])(a0, a1, a2, a3, a4, a5, a6, a7);
var dynCall_viiffiiii = Module['dynCall_viiffiiii'] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (dynCall_viiffiiii = Module['dynCall_viiffiiii'] = wasmExports['dynCall_viiffiiii'])(a0, a1, a2, a3, a4, a5, a6, a7, a8);
var dynCall_vifffi = Module['dynCall_vifffi'] = (a0, a1, a2, a3, a4, a5) => (dynCall_vifffi = Module['dynCall_vifffi'] = wasmExports['dynCall_vifffi'])(a0, a1, a2, a3, a4, a5);
var dynCall_viifffi = Module['dynCall_viifffi'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viifffi = Module['dynCall_viifffi'] = wasmExports['dynCall_viifffi'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_viffffi = Module['dynCall_viffffi'] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viffffi = Module['dynCall_viffffi'] = wasmExports['dynCall_viffffi'])(a0, a1, a2, a3, a4, a5, a6);
var dynCall_viiffffi = Module['dynCall_viiffffi'] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_viiffffi = Module['dynCall_viiffffi'] = wasmExports['dynCall_viiffffi'])(a0, a1, a2, a3, a4, a5, a6, a7);
var dynCall_vifiii = Module['dynCall_vifiii'] = (a0, a1, a2, a3, a4, a5) => (dynCall_vifiii = Module['dynCall_vifiii'] = wasmExports['dynCall_vifiii'])(a0, a1, a2, a3, a4, a5);
...
var dynCall_viifii = Module['dynCall_viifii'] = (a0, a1, a2, a3, a4, a5) => (dynCall_viifii = Module['dynCall_viifii'] = wasmExports['dynCall_viifii'])(a0, a1, a2, a3, a4, a5);
